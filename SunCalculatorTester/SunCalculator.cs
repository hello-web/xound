...
namespace SunCalculatorTester
{
    class SunCalculator
    {
        ...
        public static AeronauticalPosition CalculateSunPosition(DateTime dateTime, double latitude, double longitude)
        {
            // Convert to UTC  
            ...
            return new AeronauticalPosition(altitude * Rad2Deg, azimuth * Rad2Deg);
        }
